<div class="cover inner">
    <h1 class="cover-heading">About this application</h1>
    <p class="lead">This application was development by test my skils in a PHP language programming</p>
    <p class="lead">Without framework's, but not use a third-party libraries it was a stupid</p>
